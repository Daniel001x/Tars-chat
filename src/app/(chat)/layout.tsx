...
export default function ChatLayout({
  ...
  return (
    <div className="h-screen w-full bg-gray-100 flex overflow-hidden">
      {/* SIDEBAR */}
      <div
        className={`fixed md:relative inset-0 z-20 bg-white flex flex-col w-full md:w-80 transition-transform duration-300 ${
          isInConversation
      ...
      {/* MAIN AREA */}
      <div
        className={`flex-1 flex flex-col bg-white transition-transform duration-300 ${
          isInConversation
            ? "translate-x-0"
            : "translate-x-full md:translate-x-0"
        }`}
